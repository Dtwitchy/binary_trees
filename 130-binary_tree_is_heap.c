 ...
 */
int tree_is_complete(const binary_tree_t *tree, int i, int n_nodes)
{
	if (tree == NULL)
		return (1);
	...
	return (tree_is_complete(tree->left, (2 * i) + 1, n_nodes) &&
		tree_is_complete(tree->right, (2 * i) + 2, n_nodes));
}
